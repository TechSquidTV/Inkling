  ...
  return (
    ...
    >
      <DropdownMenuHighlightPrimitive
        mode="parent"
        className="bg-sidebar-accent absolute inset-0 z-0 rounded-sm"
      >
        {children}
      </DropdownMenuHighlightPrimitive>
    </DropdownMenuContentPrimitive>
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuHighlightItemPrimitive asChild disabled={disabled} value={id}>
      <DropdownMenuItemPrimitive
        ...
        className={cn(
          "focus:text-accent-foreground data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:text-destructive data-[variant=destructive]:*:[svg]:text-destructive! [&_svg:not([class*='text-'])]:text-muted-foreground relative flex cursor-pointer items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-inset:pl-8 data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
          className
        )}
        {...props}
      />
...
/**
 * CheckboxItem uses a simple CSS hover effect instead of the animated highlight
 * system due to ref-forwarding complexity in nested wrapper components.
 * This provides the same visual feedback with better reliability.
 */
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuCheckboxItemPrimitive
      ...
      disabled={disabled}
      className={cn(
        "hover:bg-sidebar-accent focus:text-accent-foreground relative flex cursor-pointer items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      checked={checked}
      {...props}
  ...
  return (
    <DropdownMenuHighlightItemPrimitive asChild disabled={disabled} value={id}>
      <DropdownMenuRadioItemPrimitive
        ...
        disabled={disabled}
        className={cn(
          "focus:text-accent-foreground relative flex cursor-pointer items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
          className
        )}
        {...props}
      >
  ...
  return (
    <DropdownMenuHighlightItemPrimitive asChild disabled={disabled} value={id}>
      <DropdownMenuSubTriggerPrimitive
        ...
        data-inset={inset}
        className={cn(
          'focus:text-accent-foreground data-[state=open]:text-accent-foreground flex cursor-pointer items-center rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-inset:pl-8',
