  ...
  return (
    ...
    >
      <SwitchThumbPrimitive
        className={cn(
          'bg-background dark:data-[unchecked]:bg-foreground dark:data-[checked]:bg-primary-foreground pointer-events-none relative z-10 block size-4 rounded-full ring-0'
        )}
