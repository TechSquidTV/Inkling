...
/**
 * Helper to set a ref value without triggering prop immutability lint errors.
 * Must be defined outside of components to avoid being tracked as prop mutation.
 */
