...
func newProduct(db *gorm.DB, opts ...gen.DOOption) product {
	...
	_product.productDo.UseModel(&database.Product{})
...
type IProductDo interface {
	...
	Unscoped() IProductDo
	Create(values ...*database.Product) error
	CreateInBatches(values []*database.Product, batchSize int) error
	Save(values ...*database.Product) error
	First() (*database.Product, error)
	Take() (*database.Product, error)
	Last() (*database.Product, error)
	Find() ([]*database.Product, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*database.Product, err error)
	FindInBatches(result *[]*database.Product, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*database.Product) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*database.Product, error)
	FirstOrCreate() (*database.Product, error)
	FindByPage(offset int, limit int) (result []*database.Product, count int64, err error)
...
func (p productDo) Create(values ...*database.Product) error {
	if len(values) == 0 {
		return nil
	}
...
func (p productDo) CreateInBatches(values []*database.Product, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p productDo) Save(values ...*database.Product) error {
	if len(values) == 0 {
		return nil
	}
...
func (p productDo) First() (*database.Product, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*database.Product), nil
	}
}

func (p productDo) Take() (*database.Product, error) {
...
func (p productDo) Last() (*database.Product, error) {
...
func (p productDo) Find() ([]*database.Product, error) {
	result, err := p.DO.Find()
	return result.([]*database.Product), err
}

func (p productDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*database.Product, err error) {
	buf := make([]*database.Product, 0, batchSize)
...
func (p productDo) FindInBatches(result *[]*database.Product, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p productDo) FirstOrInit() (*database.Product, error) {
...
func (p productDo) FirstOrCreate() (*database.Product, error) {
...
func (p productDo) FindByPage(offset int, limit int) (result []*database.Product, count int64, err error) {
...
func (p productDo) Delete(models ...*database.Product) (result gen.ResultInfo, err error) {
